...
import { Sparkles, ArrowLeft, Users, Plus } from "lucide-react";
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white">
                Study <span className="glow-text">Rooms</span>
              </h1>
            </div>
            <p className="text-gray-400 max-w-2xl">
              Study together in real-time. Share a code with classmates and
              learn the same material at the same time.
            </p>
          </div>
          <Link
            href="/dashboard/rooms/new"
            className="flex items-center gap-2 px-5 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-cyan-500 text-white font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all"
          >
