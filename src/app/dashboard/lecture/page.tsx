      ...
      <section className="relative z-10 max-w-6xl mx-auto px-8 py-12">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">
            Full <span className="glow-text">Lecture</span>
          </h1>
        </div>
        <p className="text-gray-400 mb-12 max-w-2xl">
          Pick a textbook PDF. The AI will analyze it, find topics, and generate
          a complete narrated lecture with chapters, examples, and diagrams.
        </p>
        ...
        {pdfs.length === 0 ? (
          <div className="glass rounded-2xl p-12 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Upload a textbook PDF first, then come back to generate a full lecture.
            </p>
            <Link
              href="/dashboard"
