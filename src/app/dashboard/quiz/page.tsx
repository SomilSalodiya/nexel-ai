      ...
      <section className="relative z-10 max-w-3xl mx-auto px-8 py-12">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">
            Quiz <span className="glow-text">Generator</span>
          </h1>
        </div>
        <p className="text-gray-400 mb-12">
          Pick a PDF and let AI generate 5 questions to test your understanding.
        </p>
        ...
        {pdfs.length === 0 ? (
          <div className="glass rounded-2xl p-12 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Upload a PDF first, then come back to generate a quiz.
            </p>
            <Link
              href="/dashboard"
