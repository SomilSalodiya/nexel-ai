...
import { Sparkles, ArrowLeft, Search as SearchIcon } from "lucide-react";
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-8 py-12">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">
            Search <span className="glow-text">Everything</span>
          </h1>
        </div>
        <p className="text-gray-400 mb-12 max-w-2xl">
          Search across all your PDFs, notes, flashcards, and exam predictions.
          Press <kbd className="px-2 py-0.5 rounded bg-white/5 border border-white/10 text-gray-300 text-xs font-mono">Ctrl+K</kbd>{" "}
